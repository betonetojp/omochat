    ...
    public partial class FormPostBar : Form
    {
        ...
        public FormPostBar()
        {
            ...
            if (scale < 2.0f)
            {
                ...
                buttonPicture.Image = new Bitmap(Resources.icons8_picture_16, size, size);
            }
            else
            {
                buttonPost.Image = new Bitmap(Resources.icons8_create_32, size, size);
                buttonPicture.Image = new Bitmap(Resources.icons8_picture_32, size, size);
            }
        }
        ...
        private void ButtonPost_Click(object sender, EventArgs e)
        {
            if (MainForm != null)
            {
                MainForm.ButtonPost_Click(RootEvent);
            }
        }
