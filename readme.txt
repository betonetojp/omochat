...
設定画面で『Create new key』ボタンを押すと新しいNostr秘密鍵を生成します。
  ...
  F2 ：時間列の表示切り替え
  F3 ：名前列の表示切り替え
  F4 ：ユーザーハッシュ列の表示切り替え（デフォルト非表示）
  F5 ：Geohash列の表示切り替え
  F9 ：コンテンツの折り返し表示の切り替え（Zキーまたは余白ダブルクリックでも動作）
  F10：ミュート設定画面（余白右クリックでも動作）
  F11：メイン画面の最小化
...
◆ 更新履歴
2025/09/15 v0.1.4
Xキーで選択行のGeohashに移動する機能を追加
Geohash列の表示状態を保存するように変更
...
名前ミュート機能を追加
チャット本文ミュート機能を追加
※どちらも部分一致でミュートします。改行で区切って複数指定可能です。

2025/08/30 v0.1.0
ミュート機能を追加
表示方法を昇順に変更（設定の『Descending order』を有効にすることで降順表示にできます）
『Scroll to new post』設定を追加
『World view』設定を追加
ショートカットキーを変更
